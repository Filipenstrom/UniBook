...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_COURSES1 = "courses1";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_COURSES1 + "(ID INTEGER PRIMARY KEY AUTOINCREMENT, NAME TEXT UNIQUE, DESCRIPTION TEXT, COURSECODE INTEGER, PROGRAMID INTEGER, FOREIGN KEY (PROGRAMID) REFERENCES program(ID))");
